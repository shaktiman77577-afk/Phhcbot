...
CONSENT = (
    ...
    "You can erase your identity any time with /deletemydata. Your name and "
    "roll number are deleted permanently; your marks stay in the anonymous "
    "pool with nothing linking them to you.\n\n"
    "Let's begin."
)
...
DELETE_CONFIRM = (
    "Erase your identity?\n\n"
    "Your name and roll number will be permanently deleted. Your marks will "
    "stay in the anonymous pool so the cutoff estimate stays accurate, but "
    "nothing will link them to you.\n\n"
    "This cannot be undone."
)

DELETED = (
    "Your name and roll number have been permanently deleted.\n\n"
    "Your marks remain in the anonymous pool. Nothing links them to you any "
    "more, and the admin panel cannot see who they belonged to either.\n\n"
    "You can register again any time with /start."
)

DELETED_FULL = (
    "Your data has been removed completely.\n\n"
    "You had not submitted any marks, so there was nothing to keep.\n\n"
    "You can register again any time with /start."
)

DELETE_NOTHING = "There is nothing stored against your account."
